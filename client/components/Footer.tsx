  ...
  return (
    <footer className="w-full bg-venera-red px-6 md:px-[133px] py-8 md:pt-14 md:pb-8">
      <div className="w-full max-w-[1246px] mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-12 max-w-[280px]">
            <div className="flex flex-col gap-[18px]">
              <a href="#" className="font-display text-sm font-bold text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">Home</a>
              <a href="#" className="font-display text-sm font-normal text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">About</a>
              <a href="#" className="font-display text-sm font-normal text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">Pricing</a>
            </div>
            <div className="flex flex-col gap-[18px]">
              <a href="#" className="font-display text-sm font-normal text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">Tokens</a>
              <a href="#" className="font-display text-sm font-normal text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">Blog</a>
              <a href="#" className="font-display text-sm font-normal text-white uppercase tracking-[1.4px] hover:opacity-80 transition-opacity">Contact Us</a>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <p className="font-display text-base text-white text-center md:text-left">
          All rights reserved
        </p>
